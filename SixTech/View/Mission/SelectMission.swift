...
import SwiftUI
 ...
 class SelectMission: ObservableObject {
     ...
     let missions: [String] = [ "길고양이 사진 찍기", "길가에 핀 꽃 사진 찍기", "하늘 사진 찍기", " 팀원 한명 이상과 신발 사진 찍기", "부피가 큰 쓰레기 사진 찍기", "파란색 병뚜껑 사진 찍기", "희귀할 것 같은 쓰레기 사진 찍기", "플로깅하는 팀원의 사진찍기", "플로깅하는 팀원의 쓰레기봉투 사진찍기", "원하는 사진 찍기"]
